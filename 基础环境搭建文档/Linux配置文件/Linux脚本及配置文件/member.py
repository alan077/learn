...
# 查询会员数
Member_Conn = MSSQL(host="xx.xx.3.13", user="Zerostadmin", pwd="$1Urd@$isJ@123.com", db="MembershipCloud")
...
# 查询商家数
Store_Conn = MSSQL(host="xx.xx.3.13", user="Jewelryadmin", pwd="6Im$E05oLV@123.com", db="MerchantCloud")
...
# 查询消费数量
Store_Expense = MSSQL(host="xx.xx.3.13", user="Zerostadmin", pwd="$1Urd@$isJ@123.com", db="MarketingCloud")
...
# 查询ERP数据
ERP_Conn = MSSQL(host="xx.xx.3.13", user="Jewelryadmin", pwd="6Im$E05oLV@123.com", db="StockingCloud")
...
# print(GoodsBasic)
# 插入数据库
ms = MSSQL(host="xx.xx.2.200", user="sa", pwd="lcb@123.com", db="Conn")
